  ...
  return (
    <div className={`relative flex items-center w-full ${className}`}>
      ...
      <input
        ...
        className="w-full rounded-xl border border-slate-200 bg-white pl-10 pr-9 py-2.5 text-xs text-slate-900 placeholder:text-slate-400 transition-colors focus:border-[#c5a059] focus:outline-hidden focus:ring-2 focus:ring-[#c5a059]/25 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-[#c5a059] dark:focus:ring-[#c5a059]/25"
      />
