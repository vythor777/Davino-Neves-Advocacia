...
function ProcessosContent() {
  ...
  return (
    <div className="app-page">
      ...
      <PageHeader
        title="Processos"
        description="Acompanhe autos judiciais, comarcas, andamentos e clientes."
      >
        <button
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <select
            ...
            className="rounded-xl border border-slate-200/80 bg-white/80 px-3 py-2 text-xs font-medium text-slate-900 focus:border-brand focus:outline-hidden dark:border-white/[0.08] dark:bg-surface dark:text-slate-200 cursor-pointer"
          >
            <option
              value="todos"
              ...
              <div className="overflow-y-auto p-5 space-y-3.5 text-xs flex-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200/80 bg-white/80 px-3 py-2 text-slate-900 placeholder:text-slate-400 focus:border-brand focus:outline-hidden dark:border-white/[0.08] dark:bg-surface dark:text-slate-100 dark:placeholder:text-slate-500"
                  />
                  {formErrors.titulo && (
                    <p className="text-rose-500 mt-1">{formErrors.titulo}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-slate-200/80 bg-white/80 px-3 py-2 text-slate-900 placeholder:text-slate-400 focus:border-brand focus:outline-hidden resize-none dark:border-white/[0.08] dark:bg-surface dark:text-slate-100 dark:placeholder:text-slate-500"
                  />
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div className="rounded-xl bg-slate-50/90 dark:bg-surface p-3.5 border border-slate-200/80 dark:border-white/[0.08] shadow-xs">
                  ...
                  <span className="text-slate-800 dark:text-slate-200 font-medium mt-0.5 block">
                    {selectedProcesso.cliente?.nome ||
                      `Cliente #${selectedProcesso.id_cliente}`}
                  </span>
                </div>
                <div className="rounded-xl bg-slate-50/90 dark:bg-surface p-3.5 border border-slate-200/80 dark:border-white/[0.08] shadow-xs">
                  <span className="text-slate-400 block text-[10px] uppercase font-semibold">
