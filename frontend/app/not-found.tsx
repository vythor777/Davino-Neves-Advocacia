  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-16 sm:py-24 flex flex-col items-center justify-center text-center animate-fade-in-up">
      ...
      <div className="relative mb-6">
        <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-brand/15 text-brand border border-brand/30 shadow-sm mx-auto">
          <FileQuestion className="h-10 w-10" />
        </div>
        <span className="absolute -bottom-2 -right-2 inline-flex items-center rounded-full bg-slate-900 px-2.5 py-0.5 font-mono text-xs font-bold text-brand border border-brand/40 shadow-xs dark:bg-black">
          404
        </span>
      </div>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-xl bg-action hover:bg-action-hover text-white font-semibold px-5 py-2.5 text-xs shadow-xs hover:shadow-md transition-all active:scale-[0.98]"
        >
      ...
      <div className="mt-12 w-full pt-8 border-t border-slate-200/60 dark:border-white/[0.06]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
          <Link
            href="/processos"
            className="legal-glass-card fio-de-luz flex flex-col items-center gap-2 p-3.5 hover:border-brand/40 transition-all hover:-translate-y-0.5"
          >
